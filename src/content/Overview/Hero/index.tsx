      ...
      >
        <Grid item md={10} lg={8} mx="auto">
          ...
          <TypographyH1 sx={{ mb: 2 }} variant="h1">
            A case monitoring system built for the modern web.
          </TypographyH1>
          <TypographyH2
            ...
            fontWeight="normal"
          >
            High performance case monitoring built with lots of powerful built
            components for fast &
            perfect web app experience.
          </TypographyH2>
          <Button
            component={Link}
          ...
          <Grid container spacing={3} mt={5}>
            <Grid item md={4}>
              ...
              <Typography variant="h4">
                ...
                <Typography component="span" variant="subtitle2">
                  A customizable component library to build faster,
            ...
            <Grid item md={4}>
              ...
              <Typography variant="h4">
                ...
                <Typography component="span" variant="subtitle2">
                  Project Aether features a modern technology stack and is built with React + Typescript.
                </Typography>
              </Typography>
            </Grid>
          </Grid>
